...
function App() {
  ...
  return (
    ...
    <div className="App container">
      <div className='jumbotron'>CURRENCYCONVERTER<img src={process.env.PUBLIC_URL + './currency.png'} style={{width: '50px', marginLeft: '5px', paddingBottom: '4px'}} alt='currency'/></div>
